...
FinTrack es una plataforma web Full Stack para la gestión de finanzas personales, desarrollada con **React, TypeScript, Java, Spring Boot y PostgreSQL**.

El proyecto permite gestionar ingresos, gastos y presupuestos, crear metas de ahorro y registrar aportes, además de visualizar métricas y análisis financieros mediante un dashboard interactivo.
...
* Contraseñas almacenadas de forma segura mediante hashing con BCrypt.
...
Las contraseñas se almacenan mediante hashing con BCrypt y los secretos de configuración se gestionan mediante variables de entorno.
